...
export const caseStudiesTranslations: Record<Language, { name: string; category: string; imageKey: string; client: string; goal: string; duration: string; result: string }[]> = {
  pl: [
    { name: 'Vektor Automation', category: 'Weryfikacja dostawcy', imageKey: 'vektor', client: 'Producent systemów automatyki przemysłowej', goal: 'Weryfikacja chińskiego dostawcy strategicznych podzespołów elektronicznych', duration: '3 tygodnie', result: 'Skuteczne wykrycie rozbieżności w certyfikacji ISO i strukturze kapitałowej. Ochrona klienta przed ryzykiem finansowym i operacyjnym.' },
    { name: 'Arcom Electronics', category: 'Wejście na rynek', imageKey: 'arcom', client: 'Dystrybutor elektroniki klasy premium', goal: 'Opracowanie strategii ekspansji i wejście na rynek chiński w modelu B2B', duration: '3 miesiące', result: 'Udana implementacja sprzedaży cross-border. Nawiązanie strategicznej współpracy z kluczowymi dystrybutorami w regionie Szanghaju.' },
    { name: 'Aktir', category: 'Due Diligence', imageKey: 'aktir', client: 'Operator logistyki międzynarodowej', goal: 'Pełny due diligence operacyjny i finansowy chińskiego partnera logistycznego', duration: '4 tygodnie', result: 'Transparentna analiza kondycji finansowej partnera. Optymalizacja warunków kontraktowych i wzmocnienie pozycji negocjacyjnej.' },
    { name: 'Orvanta', category: 'Optymalizacja łańcucha', imageKey: 'orvanta', client: 'Platforma e-commerce z sektora nowoczesnych technologii', goal: 'Restrukturyzacja łańcucha dostaw i optymalizacja modelu sourcingowego', duration: '6 tygodni', result: 'Redukcja kosztów operacyjnych i logistycznych o 28%. Wdrożenie bezpośredniego modelu współpracy z certyfikowanymi producentami.' },
  ],
  en: [
    { name: 'Vektor Automation', category: 'Supplier Verification', imageKey: 'vektor', client: 'Industrial automation systems manufacturer', goal: 'Verification of Chinese strategic electronic component suppliers', duration: '3 weeks', result: 'Successful detection of discrepancies in ISO certification and ownership structure. Protected the client from financial and operational risks.' },
    { name: 'Arcom Electronics', category: 'Market Entry', imageKey: 'arcom', client: 'Premium electronics equipment distributor', goal: 'Development of expansion strategy and B2B market entry in China', duration: '3 months', result: 'Successful implementation of cross-border sales. Established strategic cooperation with key distributors in the Shanghai region.' },
    { name: 'Aktir', category: 'Due Diligence', imageKey: 'aktir', client: 'International logistics operator', goal: 'Full operational and financial due diligence of a Chinese logistics partner', duration: '4 weeks', result: 'Transparent analysis of the partner\'s financial health. Optimized contract terms and strengthened the client\'s negotiating position.' },
    { name: 'Orvanta', category: 'Supply Chain Optimization', imageKey: 'orvanta', client: 'E-commerce platform in the high-tech sector', goal: 'Supply chain restructuring and sourcing model optimization', duration: '6 weeks', result: '28% reduction in operational and logistics costs. Implemented a direct cooperation model with certified manufacturers.' },
  ],
  cn: [
    { name: 'Vektor Automation', category: '供应商验证', imageKey: 'vektor', client: '工业自动化系统制造商', goal: '验证中国战略电子零部件供应商', duration: '3周', result: '成功检测出ISO认证和股权结构方面的差异。保护客户免受财务和运营风险。' },
    { name: 'Arcom Electronics', category: '市场进入', imageKey: 'arcom', client: '高端电子设备分销商', goal: '制定中国扩张战略和B2B市场准入方案', duration: '3个月', result: '成功实施跨境销售。与上海地区的关键分销合作伙伴建立了战略合作关系。' },
    { name: 'Aktir', category: '尽职调查', imageKey: 'aktir', client: '国际物流运营商', goal: '对中国物流合作伙伴进行全面运营和财务尽职调查', duration: '4周', result: '对合作伙伴的财务状况进行透明分析。优化了合同条款并加强了客户的谈判地位。' },
    { name: 'Orvanta', category: '供应链优化', imageKey: 'orvanta', client: '高科技行业电子商务平台', goal: '供应链重组及采购模式优化', duration: '6周', result: '运营和物流成本降低28%。实施了与认证制造商的直接合作模式。' },
  ],
};
...
export const carouselServicesTranslations: Record<Language, { title: string; description: string }[]> = {
  pl: [
    { title: 'Strategia wobec Chin', description: 'Doradztwo strategiczne, scenariusze wejścia na rynek i mapy ryzyk. Profesjonalne briefingi dla zarządów planujących ekspansję w Chinach.' },
    { title: 'Analizy rynku i weryfikacja partnerów', description: 'Dogłębne badania sektorów, analiza konkurencji oraz wielopoziomowa weryfikacja kontrahentów i due diligence chińskich podmiotów.' },
    { title: 'Wejście na rynek Polska ↔ Chiny', description: 'Kompleksowe wsparcie w wyborze modelu biznesowego, obsługa regulacyjna i precyzyjna identyfikacja kluczowych partnerów handlowych.' },
    { title: 'Import, eksport i łańcuch dostaw', description: 'Profesjonalne audyty dostawców, optymalizacja kosztów logistyki, certyfikacja, nadzór produkcji oraz transport międzynarodowy.' },
    { title: 'Marketing i pozycjonowanie', description: 'Skuteczne pozycjonowanie marki na rynkach lokalnych, dopasowana strategia komunikacji oraz profesjonalne materiały sprzedażowe.' },
    { title: 'Misje biznesowe i szkolenia', description: 'Organizacja misji technologicznych, matchmaking B2B oraz szkolenia z zakresu kultury biznesu i systemów gospodarczych Chin.' },
  ],
  en: [
    { title: 'China Strategy', description: 'Strategic advisory, market entry scenarios, and risk mapping. Professional briefings for boards planning expansion in the Chinese market.' },
    { title: 'Market Analysis & Partner Verification', description: 'In-depth sector research, competitive analysis, and multi-level contractor verification and due diligence of Chinese entities.' },
    { title: 'Market Entry Poland ↔ China', description: 'Comprehensive support in business model selection, regulatory compliance, and precise identification of key trade partners.' },
    { title: 'Import, Export & Supply Chain', description: 'Professional supplier audits, logistics cost optimization, certification, production supervision, and international transport.' },
    { title: 'Marketing & Positioning', description: 'Effective brand positioning in local markets, tailored communication strategies, and professional sales enablement materials.' },
    { title: 'Business Missions & Training', description: 'Organization of technology missions, B2B matchmaking, and training on China\'s business culture and economic systems.' },
  ],
  cn: [
    { title: '对华战略', description: '战略咨询、市场准入情景规划及风险制图。为计划在中国市场扩张的董事会提供专业简报。' },
    { title: '市场分析与合作伙伴验证', description: '深入的行业研究、竞争分析、多级别承包商验证以及对中国实体的尽职调查。' },
    { title: '市场进入 波兰 ↔ 中国', description: '在商业模式选择、监管合规以及精确识别关键贸易伙伴方面提供全面支持。' },
    { title: '进出口与供应链', description: '专业的供应商审计、物流成本优化、认证、生产监督及国际运输管理。' },
    { title: '营销与市场定位', description: '在当地市场进行有效的品牌定位，量身定制的传播策略及专业的销售支持材料。' },
    { title: '商务考察与培训', description: '组织技术考察、B2B对接，以及关于中国商业文化和经济体系的专业培训。' },
  ],
};
