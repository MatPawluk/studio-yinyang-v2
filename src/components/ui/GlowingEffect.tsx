          ...
          style={
            {
              ...
              "--gradient":
                variant === "white"
                  ...
                  : `radial-gradient(circle, #c4ff00 10%, #c4ff0000 20%),
                radial-gradient(circle at 40% 40%, #00ffa3 5%, #00ffa300 15%),
                radial-gradient(circle at 60% 60%, #c4ff00 10%, #c4ff0000 20%), 
                radial-gradient(circle at 40% 60%, #00ffa3 10%, #00ffa300 20%),
                repeating-conic-gradient(
                  from 236.84deg at 50% 50%,
                  #c4ff00 0%,
                  #00ffa3 calc(25% / var(--repeating-conic-gradient-times)),
                  #c4ff00 calc(50% / var(--repeating-conic-gradient-times)), 
                  #00ffa3 calc(75% / var(--repeating-conic-gradient-times)),
                  #c4ff00 calc(100% / var(--repeating-conic-gradient-times))
                )`,
