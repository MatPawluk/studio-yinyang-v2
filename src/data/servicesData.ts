...
export const servicesData: Record<string, ServiceData> = {
  ...
  'szkolenia-kultura': {
    ...
    subtitle: 'Misje biznesowe i szkolenia',
    image: serviceStrategy,
    description: 'Praktyczne szkolenia i warsztaty dotyczące chińskiej kultury biznesowej, etykiety, budowania relacji (Guanxi) i technik negocjacyjnych. Przygotowujemy zespoły i zarządy do bezpośrednich kontaktów z chińskimi partnerami, eliminując najczęstsze błędy kulturowe i komunikacyjne, które mogą zablokować projekt lub trwale zamknąć relację.',
    whenItMakesSense: [
      'Przed ważnymi negocjacjami z chińskimi partnerami.',
      'Zespół nie ma doświadczenia w kontaktach z Azją.',
      'Chcecie uniknąć wpadek kulturowych, które mogą kosztować projekt.',
      'Onboarding zespołu przed wizytą w Chinach lub przed rozpoczęciem współpracy.',
    ],
    problemsSolved: [
      'Przygotowanie do negocjacji z uwzględnieniem chińskiego kodu kulturowego.',
      'Zrozumienie kultury biznesowej, hierarchii i roli Guanxi.',
      'Budowanie efektywnych, długoterminowych relacji z chińskimi partnerami.',
    ],
    scope: {
      includes: [
        'Przygotowanie dedykowanego programu szkolenia.',
        'Warsztaty praktyczne z elementami symulacji negocjacyjnych.',
        'Analiza case studies i typowych scenariuszy współpracy PL-CN.',
        'Materiały szkoleniowe i referencyjne.',
        'Q&A i konsultacje.',
      ],
      excludes: [
        'Udziału w realnych negocjacjach (osobna usługa: wsparcie negocjacyjne).',
      ],
    },
    deliverables: [
      'Szkolenie (4-8h): Zamknięta sesja warsztatowa (online lub stacjonarnie).',
      'Materiały praktyczne: kulturowy briefing, checklisty, do\'s and don\'ts.',
      'Feedback i rekomendacje dotyczące konkretnych planowanych interakcji.',
    ],
    workModel: {
    ...
    caseStudy: {
      ...
      situation: 'Przygotowanie do negocjacji z chińskim dostawcą komponentów. Zespół nie miał wcześniejszego doświadczenia w bezpośrednich kontaktach z partnerami z Chin.',
      actions: 'Przeprowadzono warsztat negocjacyjny obejmujący symulacje scenariuszy, analizę hierarchii decyzyjnej po stronie partnera oraz przygotowanie strategii komunikacyjnej.',
      result: 'Zespół pewny siebie i przygotowany. Negocjacje zakończone podpisaniem umowy ramowej w pierwszej rundzie spotkań.',
    },
  },
};
